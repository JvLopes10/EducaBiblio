...
CREATE TABLE IF NOT EXISTS `Biblioteca`.`aluno` (
  ...
  CONSTRAINT `fk_Aluno_Turma1`
    ...
    REFERENCES `Biblioteca`.`turma` (`AnodeInicio`))
ENGINE = InnoDB
AUTO_INCREMENT = 6
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS `Biblioteca`.`devolucao` (
  ...
  INDEX `fk_devolucao_empestimo1_idx` (`empestimo_idEmpestimo` ASC) VISIBLE,
  CONSTRAINT `fk_devolucao_empestimo1`
    FOREIGN KEY (`empestimo_idEmpestimo`)
    REFERENCES `Biblioteca`.`empestimo` (`idEmpestimo`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
